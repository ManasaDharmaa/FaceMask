...
from .views import admin_login, admin_logout, voting_page, start, dbg
...
urlpatterns = [
    ...
    path('admin-login/', admin_login, name='admin_login'),  # New URL for admin login
    path('admin-logout/', admin_logout, name='admin_logout'),  # New URL for admin logout
    path('voting-page/', voting_page, name='voting_page'),  # New URL for voting page    
]
